...
class seatsFilledException extends Throwable{
    public String toString(){
        return "\nSeats Full\nCannot accomodate more students\n";
    }
}
...
class student{
    ...
    static void checkSeats(int i) throws seatsFilledException{
        if(i>25) throw new seatsFilledException();
    }
